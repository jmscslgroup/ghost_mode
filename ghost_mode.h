...
struct B_ghost_mode_T {
  ...
  SL_Bus_ghost_mode_geometry_msgs_AccelStamped In1_e;// '<S59>/In1'
...
//  '<S7>'   : 'ghost_mode/PID JMS 1/Anti-windup'
//  '<S8>'   : 'ghost_mode/PID JMS 1/D Gain'
//  '<S9>'   : 'ghost_mode/PID JMS 1/Filter'
//  '<S10>'  : 'ghost_mode/PID JMS 1/Filter ICs'
//  '<S11>'  : 'ghost_mode/PID JMS 1/I Gain'
//  '<S12>'  : 'ghost_mode/PID JMS 1/Ideal P Gain'
//  '<S13>'  : 'ghost_mode/PID JMS 1/Ideal P Gain Fdbk'
//  '<S14>'  : 'ghost_mode/PID JMS 1/Integrator'
//  '<S15>'  : 'ghost_mode/PID JMS 1/Integrator ICs'
//  '<S16>'  : 'ghost_mode/PID JMS 1/N Copy'
//  '<S17>'  : 'ghost_mode/PID JMS 1/N Gain'
//  '<S18>'  : 'ghost_mode/PID JMS 1/P Copy'
//  '<S19>'  : 'ghost_mode/PID JMS 1/Parallel P Gain'
//  '<S20>'  : 'ghost_mode/PID JMS 1/Reset Signal'
//  '<S21>'  : 'ghost_mode/PID JMS 1/Saturation'
//  '<S22>'  : 'ghost_mode/PID JMS 1/Saturation Fdbk'
//  '<S23>'  : 'ghost_mode/PID JMS 1/Sum'
//  '<S24>'  : 'ghost_mode/PID JMS 1/Sum Fdbk'
//  '<S25>'  : 'ghost_mode/PID JMS 1/Tracking Mode'
//  '<S26>'  : 'ghost_mode/PID JMS 1/Tracking Mode Sum'
//  '<S27>'  : 'ghost_mode/PID JMS 1/Tsamp - Integral'
//  '<S28>'  : 'ghost_mode/PID JMS 1/Tsamp - Ngain'
//  '<S29>'  : 'ghost_mode/PID JMS 1/postSat Signal'
//  '<S30>'  : 'ghost_mode/PID JMS 1/preSat Signal'
//  '<S31>'  : 'ghost_mode/PID JMS 1/Anti-windup/Cont. Clamping Parallel'
//  '<S32>'  : 'ghost_mode/PID JMS 1/Anti-windup/Cont. Clamping Parallel/Dead Zone'
//  '<S33>'  : 'ghost_mode/PID JMS 1/Anti-windup/Cont. Clamping Parallel/Dead Zone/Enabled'
//  '<S34>'  : 'ghost_mode/PID JMS 1/D Gain/Internal Parameters'
//  '<S35>'  : 'ghost_mode/PID JMS 1/Filter/Cont. Filter'
//  '<S36>'  : 'ghost_mode/PID JMS 1/Filter ICs/Internal IC - Filter'
//  '<S37>'  : 'ghost_mode/PID JMS 1/I Gain/Internal Parameters'
//  '<S38>'  : 'ghost_mode/PID JMS 1/Ideal P Gain/Passthrough'
//  '<S39>'  : 'ghost_mode/PID JMS 1/Ideal P Gain Fdbk/Disabled'
//  '<S40>'  : 'ghost_mode/PID JMS 1/Integrator/Continuous'
//  '<S41>'  : 'ghost_mode/PID JMS 1/Integrator ICs/Internal IC'
//  '<S42>'  : 'ghost_mode/PID JMS 1/N Copy/Disabled'
//  '<S43>'  : 'ghost_mode/PID JMS 1/N Gain/Internal Parameters'
//  '<S44>'  : 'ghost_mode/PID JMS 1/P Copy/Disabled'
//  '<S45>'  : 'ghost_mode/PID JMS 1/Parallel P Gain/Internal Parameters'
//  '<S46>'  : 'ghost_mode/PID JMS 1/Reset Signal/Disabled'
//  '<S47>'  : 'ghost_mode/PID JMS 1/Saturation/Enabled'
//  '<S48>'  : 'ghost_mode/PID JMS 1/Saturation Fdbk/Disabled'
//  '<S49>'  : 'ghost_mode/PID JMS 1/Sum/Sum_PID'
//  '<S50>'  : 'ghost_mode/PID JMS 1/Sum Fdbk/Disabled'
//  '<S51>'  : 'ghost_mode/PID JMS 1/Tracking Mode/Enabled'
//  '<S52>'  : 'ghost_mode/PID JMS 1/Tracking Mode Sum/Tracking Mode'
//  '<S53>'  : 'ghost_mode/PID JMS 1/Tsamp - Integral/Passthrough'
//  '<S54>'  : 'ghost_mode/PID JMS 1/Tsamp - Ngain/Passthrough'
//  '<S55>'  : 'ghost_mode/PID JMS 1/postSat Signal/Forward_Path'
//  '<S56>'  : 'ghost_mode/PID JMS 1/preSat Signal/Forward_Path'
